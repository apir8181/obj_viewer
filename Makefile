...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Tue Apr 30 11:35:41 2013
# Project:  opengl.pro
# Template: app
...
LIBS          = $(SUBLIBS)  -L/usr/local/qt4/lib -L/usr/X11R6/lib64 -lQtOpenGL -L/usr/local/qt4/lib -L/usr/X11R6/lib64 -lQtGui -lQtCore -lGL -lpthread -lGLU -lglut
AR            = ar cqs
RANLIB        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/opengl1.0.0/ && $(COPY_FILE) --parents mainwindow.h parser.h viewer.h .tmp/opengl1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp parser.cpp viewer.cpp .tmp/opengl1.0.0/ && (cd `dirname .tmp/opengl1.0.0` && $(TAR) opengl1.0.0.tar opengl1.0.0 && $(COMPRESS) opengl1.0.0.tar) && $(MOVE) `dirname .tmp/opengl1.0.0`/opengl1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/opengl1.0.0
